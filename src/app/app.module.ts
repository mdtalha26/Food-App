...
@NgModule({
  declarations: [
    ...
    ViewRestaurantDocumentsDialogComponent,
    FooterComponent,
    RestaurantComponent,
    ViewMyRestaurantsComponent,
    AddMenuToRestaurantComponent,
    ViewRestaurantMenusComponent,
    UpdateMenuInRestaurantComponent,
    ShowFoodItemsComponent,
    AddFoodItemsToMenuComponent,
    ViewFoodItemImagesDialogComponent,
    UpdateFoodItemComponent,
    ViewFoodItemDetailsComponent,
    BuyFoodItemComponent,
